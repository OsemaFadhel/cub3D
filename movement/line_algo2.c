...
/*   Updated: 2024/04/11 19:33:33 by ofadhel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	cam_left(t_game *game)
{
	...
	game->player.director_vector_x = game->player.director_vector_x
		* cos(game->player.rot_speed) - game->player.director_vector_y * sin(game->player.rot_speed);
	...
	game->camera.plane_x = game->camera.plane_x
		* cos(game->player.rot_speed) - game->camera.plane_y * sin(game->player.rot_speed);
